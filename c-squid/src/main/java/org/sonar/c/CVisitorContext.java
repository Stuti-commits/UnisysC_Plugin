...
public class CVisitorContext {

  private final String fileContent;
  private final AstNode rootTree;
  private final RecognitionException parsingException;

  public CVisitorContext(String fileContent, AstNode tree) {
    this(fileContent, tree, null);
  }

  public CVisitorContext(String fileContent, RecognitionException parsingException) {
