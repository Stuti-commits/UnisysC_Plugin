...
public class CLexerTest {
  ...
  public void decimal_literal() {
    assertThat(lexer.lex("0"), hasToken("0", CTokenType.NUMERIC_LITERAL));
    assertThat(lexer.lex("1239"), hasToken("1239", CTokenType.NUMERIC_LITERAL));
  }

  @Test
  public void hex_literal() {
    assertThat(lexer.lex("0xFF"), hasToken("0xFF", CTokenType.NUMERIC_LITERAL));
  }

  @Test
  public void float_literal() {
    assertThat(lexer.lex("12.9E-1"), hasToken("12.9E-1", CTokenType.NUMERIC_LITERAL));
    assertThat(lexer.lex(".129e+1"), hasToken(".129e+1", CTokenType.NUMERIC_LITERAL));
  }
